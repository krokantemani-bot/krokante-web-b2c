  ...
  return (
    ...
    >
      ...
      <motion.div 
        ...
        className="w-full max-w-[95%] xl:max-w-6xl mx-auto grid grid-cols-1 xl:grid-cols-3 gap-4 xl:gap-8 text-center mb-10 relative z-10 origin-center px-4 sm:px-8"
      >
        {/* Paso 1 */}
        <div className="px-2">
          <h3 className="font-display text-lg sm:text-xl lg:text-2xl xl:text-3xl uppercase tracking-normal leading-snug">
